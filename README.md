...
------------------ | ------------ | -------------------------- | ----- | ------
2.0.25 (in development)  | n/a          | 1,1, 1,2, 2.0 | [branch develop_2.0](https://github.com/wordnik/swagger-ui/blob/master) | [Issues](https://github.com/wordnik/swagger-ui/milestones/v2.1.0)
