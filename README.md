...
## Compatibility
The OpenAPI Specification has undergone 5 revisions since its initial creation in 2010.  Compatibility between Swagger UI and the OpenAPI Specification is as follows:
