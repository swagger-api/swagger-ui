...
let c = {}
const memoize = f => (x => (x in c ? c[x] : (c[x] = f(x))));

export const memoizedCreateXMLExample = memoize(createXMLExample)

export const memoizedSampleFromSchema = memoize(sampleFromSchema)
