  ...
  render() {
    ...
    return (
      <Container fullscreen>
        ...
        <Button onClick={showEditorAction} unstyled><span>{showEditor ? "Hide" : "Show"} Editor</span></Button>
        <Button onClick={specActions.formatIntoYaml} unstyled><span>Format contents</span></Button>
