  ...
  render() {
    ...
    return (
      <Container fullscreen>
        ...
        <Button onClick={showEditorAction}><span>{showEditor ? "Hide" : "Show"} Editor</span></Button>
        <Button onClick={specActions.formatIntoYaml}><span>Format contents</span></Button>
