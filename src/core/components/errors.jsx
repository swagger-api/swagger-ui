    ...
    return (
      <pre className="errors-wrapper">
        <hgroup className="error">
          ...
          <button className="btn errors__clear-btn" onClick={ toggleVisibility }>{ isVisible ? "Esconder" : "Exibir" }</button>
        </hgroup>
      ...
      { !error ? null :
        <div>
          ...
          <div style={{ "text-decoration": "underline", "cursor": "pointer" }}>
            { errorLine && jumpToLine ? <a onClick={jumpToLine.bind(null, errorLine)}>Pular para linha { errorLine }</a> : null }
          </div>
        </div>
      }
    </div>
    ...
    <div className="error-wrapper">
      { !error ? null :
        <div>
          ...
          <div style={{ "text-decoration": "underline", "cursor": "pointer" }}>
            { jumpToLine ? (
              <a onClick={jumpToLine.bind(null, error.get("line"))}>Pular para linha { error.get("line") }</a>
            ) : null }
          </div>
        </div>
      }
