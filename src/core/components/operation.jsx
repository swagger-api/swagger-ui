...
export default class Operation extends PureComponent {
  ...
  hasParameterError = (value) => {
    this.setState({ hasErrors: value })
  }
        ...
        <OperationSummary operationProps={operationProps} toggleShown={toggleShown} getComponent={getComponent} authActions={authActions} authSelectors={authSelectors} specPath={specPath} />
          <Collapse isOpened={isShown}>
            ...
            <div className={(!tryItOutEnabled || !response || !allowTryItOut) ? "execute-wrapper" : "btn-group"}>
              { this.state.hasErrors && <h4 className="has-errors">Existe algum erro com seus parâmetros corrija e tente novamente</h4>}
              { !tryItOutEnabled || !allowTryItOut ? null :
                  ...
                  <Execute
                    ...
                    method={ method }
                    onExecute={ onExecute }
                    hasParameterError={ this.hasParameterError }
                     />
              }
