...
export default class Operation extends PureComponent {
  ...
  render() {
    ...
    return (
        <div ref={(elem) => {this.ref = elem}} className={deprecated ? "opblock opblock-deprecated" : isShown ? `opblock opblock-${method} is-open` : `opblock opblock-${method}`} id={createDeepLinkPath(isShownKey.join("-"))} >
