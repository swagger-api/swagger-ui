...
export default class ArrayModel extends Component {
  ...
  render(){
    let { getComponent, getConfigs, specPath, schema, depth, expandDepth, name } = this.props
    ...
    return <span className="model">
      <ModelCollapse title={titleEl} expanded={ depth <= expandDepth } collapsedContent="[...]">
        [
          ...
          <span><Model { ...this.props } specPath={[...specPath, "items"]} getConfigs={ getConfigs } name={null} schema={ items } required={ false } depth={ depth + 1 } /></span>
        ]
      </ModelCollapse>
    </span>
  }
