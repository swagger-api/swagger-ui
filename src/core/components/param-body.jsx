...
export default class ParamBody extends PureComponent {
  ...
  onChange = (value, { isEditBox, isXml }) => {
    if(this.state.isFirstValue){
      this.setState({isFirstValue: false})
      this.setState({valueBackup: value})
    }
  ...
  clearContent = () => this.setState({value: this.state.valueBackup})
  ...
  render() {
    ...
    let { value, isEditBox, valueBackup } = this.state
    ...
    return (
      <div className="body-param" data-param-name={param.get("name")} data-param-in={param.get("in")}>
        ...
        <div className="body-param-options">
                       ...
                       : <div className="body-param-edit">
                        <Button className={isEditBox ? "btn cancel body-param__example-edit" : "btn edit body-param__example-edit"}
                         ...
                         </Button>
                         {
                           !isEditBox ? null
                            :
                            <Button className="btn clear" onClick={this.clearContent}>
                              Voltar para conteúdo inicial
                            </Button>
                          }
                         </div>
          }
          ...
          {/* <label htmlFor="">
            <span>Content-Type do parâmetro</span>
