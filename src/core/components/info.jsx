    ...
    return (
      <div className="info">
        <hgroup className="main">
          ...
          <p> Antes de começar a desenvolver sua integração, leia a documentação com &nbsp;
            <a href='https://atendimento.vindi.com.br/hc/pt-br/articles/203020644' target='_blank'>os primeiros passos para começar a desenvolver com a API Vindi.</a>
            &nbsp;
            Lá você encontra instruções sobre autenticação, segurança e demais questões técnicas.
          </p>
        </hgroup>
