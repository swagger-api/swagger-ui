...
export default class ResponseBody extends React.PureComponent {
  ...
  render() {
    ...
    if (
      ...
      bodyEl = <HighlightCode downloadable={ downloadName + ".json" } value={ body } />
      ...
      bodyEl = <HighlightCode downloadable={ downloadName + ".xml" } value={ body } />

      // HTML or Plain Text
    } else if (lowerCase(contentType) === "text/html" || /text\/plain/.test(contentType)) {
      bodyEl = <HighlightCode downloadable={ downloadName + ".html" } value={ content } />
      ...
      bodyEl = <HighlightCode downloadable={ downloadName + ".txt" } value={ content } />
      ...
      if(parsedContent) {
        ...
        bodyEl = <div>
          ...
          <HighlightCode downloadable={ downloadName + ".txt" } value={ parsedContent } />
        </div>
