...
export default class ParamBody extends PureComponent {
  ...
  render() {
    ...
    const KongContentType = getComponent("KongContentType")
    ...
    return (
      <div className="body-param">
        <div className="param-content-type">
          ...
          <KongContentType value={consumesValue} contentTypes={consumes} onChange={onChangeConsumes} className="body-param-content-type" />
        </div>
        {
          isEditBox && isExecute
