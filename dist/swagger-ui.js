...
function program11(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                    ";
  stack1 = helpers['if'].call(depth0, depth0.responseCodes, {hash:{},inverse:self.noop,fn:self.program(7, program7, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                    ";
...
helpers = helpers || Handlebars.helpers; data = data || {};
  ...
  buffer += "<ul class=\"operations\">\n  <li class=\"doc operation\" id=\"";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "_doc\">\n    <div class=\"heading\">\n      <h3><span class=\"http_method\"><a class=\"toggleOperation\" href=\"#!/";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "/doc\">doc</a></span><span class=\"path\"><a class=\"toggleOperation\" href=\"#!/";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "/doc\">General Documentation</a></span></h3>\n    </div>\n    <div class=\"content\" id=\"";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "_doc_content\" style=\"display:none;\">\n        ";
...
(function() {
  var ContentTypeView, DocView, HeaderView, MainView, OperationView, ParameterView, ResourceView, SignatureView, StatusCodeView, SwaggerUi,
  ...
  DocView = (function(_super) {
    ...
    DocView.prototype.toggleOperationContent = function() {
      var elem;
      elem = $('#' + this.model.name + "_doc_content");
      if (elem.is(':visible')) {
  ...
  ResourceView = (function(_super) {
    ...
    ResourceView.prototype.render = function() {
      var docView, operation, _i, _len, _ref;
      ...
      if (this.model.overview) {
        ...
        $('.endpoints', $(this.el)).append(docView.render().el);
      }
      this.number = 0;
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.render = function() {
      ...
      _ref1 = this.model.responseCodes;
