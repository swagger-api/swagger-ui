...
(function() {
  var Choices, ContentTypeView, Expansions, Filters, HeaderView, MainView, NavView, Operation, OperationView, Param, ParameterChoiceView, ParameterContentTypeView, ParameterView, ResourceView, ResponseContentTypeView, Signature, SignatureView, StatusCodeView, SwaggerUi,
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.addResource = function(resource, resourceViewId) {
      var resourceView;
  ...
  ResourceView = (function(_super) {
    ...
    ResourceView.prototype.addOperation = function(swaggerOperation) {
      var className, id, operation, operationView;
