...
function program6(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</div>\n<div id='main_nav_container' style=\"position:fixed; left:200px\">\n</div>\n<div id='resources_container'>\n    <ul id='resources'>\n    </ul>\n</div>\n";
  return buffer;
  });
})();
...
function program1(depth0,data) {
  ...
  buffer += "\n	<li>\n		<a href=\"#"
    ...
    + "</a>\n		<ul>\n		";
  stack2 = helpers.each.call(depth0, ((stack1 = depth0.attributes),stack1 == null || stack1 === false ? stack1 : stack1.operationsArray), {hash:{},inverse:self.noop,fn:self.program(2, program2, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n		</ul>\n	</li>\n";
  return buffer;
  }
function program2(depth0,data) {
  ...
  buffer += "\n			<li>\n				<a href=\"#"
    + escapeExpression(((stack1 = ((stack1 = depth0.attributes),stack1 == null || stack1 === false ? stack1 : stack1.viewId)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\">"
    + escapeExpression(((stack1 = ((stack1 = depth0.attributes),stack1 == null || stack1 === false ? stack1 : stack1.nickname)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</a>\n			</li>\n		";
  return buffer;
  }
...
(function() {
  var Api, Choices, ContentTypeView, Expansions, Filters, HeaderView, MainView, NavView, Operation, OperationView, Param, ParameterChoiceView, ParameterContentTypeView, ParameterView, Resource, ResourceView, ResponseContentTypeView, Signature, SignatureView, StatusCodeView, SwaggerUi,
  ...
  Resource = (function(_super) {
    ...
    Resource.prototype.initialize = function() {
      var counter, methods, nickname, swaggerOperation, wrappedOperationModels, _i, _len, _ref;
      methods = {};
      ...
      return this.set('operationsArray', wrappedOperationModels);
    };
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.addResources = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push($('#resources').append(resourceView.render().el));
      }
      return _results;
    };
    ...
    MainView.prototype.addNav = function() {
      ...
      return $('#main_nav_container').append(navView.render().el);
    };
  ...
  ResourceView = (function(_super) {
    ...
    ResourceView.prototype.addOperations = function() {
      var operationModel, operationView, _i, _len, _ref, _results;
      _ref = this.model.get('operationsArray');
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push($('.endpoints', $(this.el)).append(operationView.render().el));
      }
      return _results;
    };
