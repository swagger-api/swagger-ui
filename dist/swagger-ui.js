...
(function() {
  var Choices, ContentTypeView, Expansions, Filters, HeaderView, MainView, NavView, Operation, OperationView, Param, ParameterChoiceView, ParameterContentTypeView, ParameterView, Resource, ResourceView, ResponseContentTypeView, Signature, SignatureView, StatusCodeView, SwaggerUi,
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.addResource = function(resourceData, resourceViewId) {
      var resourceModel, resourceView;
  ...
  ResourceView = (function(_super) {
    ...
    ResourceView.prototype.render = function() {
      var operationModel, _i, _len, _ref;
      $(this.el).html(Handlebars.templates.resource(this.model.toJSON()));
      _ref = this.model.get('operationsArray');
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        operationModel = _ref[_i];
        this.addOperation(operationModel);
      }
      return this;
    };

    ResourceView.prototype.addOperation = function(operationModel) {
      var operationView;
