...
(function() {
  ...
  SwaggerOperation = (function() {
    ...
    function SwaggerOperation(nickname, path, httpMethod, parameters, summary, notes, responseClass, errorResponses, resource, consumes, produces) {
      var errResp, parameter, v, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      ...
      _ref1 = this.errorResponses;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        errResp = _ref1[_i];
        if (((_ref2 = errResp.responseClass) != null ? _ref2.toLowerCase() : void 0) === 'void') {
          errResp.responseClass = void 0;
        }
        if (errResp.responseClass != null) {
          errResp.responseClassSignature = this.getSignature(errResp.responseClass, this.resource.models);
          errResp.responseSampleJSON = this.getSampleJSON(errResp.responseClass, this.resource.models);
        }
      }
      ...
      for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
        ...
        if (parameter.allowableValues != null) {
          ...
          if (parameter.allowableValues.values != null) {
            ...
            _ref4 = parameter.allowableValues.values;
