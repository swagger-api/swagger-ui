...
(function() {
  var SwaggerApi, SwaggerEndpoint, SwaggerModel, SwaggerModelProperty, SwaggerOperation, SwaggerRequest, SwaggerResource,
  ...
  SwaggerResource = (function() {
    ...
    SwaggerResource.prototype.addEndpoint = function(endpoint) {
      var new_operations;
      new_operations = this.addOperations(endpoint.path, endpoint.operations);
      endpoint = new SwaggerEndpoint(endpoint, new_operations);
      return this.endpointsArray.push(endpoint);
    };

    SwaggerResource.prototype.addOperations = function(resource_path, ops) {
      var consumes, o, op, return_operations, _i, _len;
      return_operations = [];
      if (ops) {
  ...
  SwaggerEndpoint = (function() {

    function SwaggerEndpoint(endpoint, operations) {
      var op, _i, _len, _ref;
      this.path = endpoint.path;
      this.description = endpoint.description;
      this.operationsArray = operations;
      this.operations = {};
      _ref = this.operationsArray;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        op = _ref[_i];
        this.operations[op.nickname] = op;
      }
