...
(function() {
  ...
  SwaggerOperation = (function() {
    ...
    function flattenParameters(parameters, resource){
      var parameter, i, j, property;
      for (i = 0; i < parameters.length; i++) {
        parameter = parameters[i];
        type = resource.models && resource.models[parameter.dataType];
        if(type){
          parameters.splice(i, 1);
          for (j = 0; j < type.properties.length; j++){
            property = type.properties[j];
    ...
    function SwaggerOperation(nickname, path, httpMethod, parameters, summary, notes, responseClass, resource) {
      ...
      this.parameters = flattenParameters(parameters ? parameters : [], resource);
